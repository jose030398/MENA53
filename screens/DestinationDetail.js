        ...
        <View style={styles.container}>
                ...
                >
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ marginHorizontal: SIZES.radius, justifyContent: 'space-around' }}>
                            <Text style={{ ...FONTS.h3 }}>LIBERACIONES POR IMEI</Text>
                    ...
                    <View style={{ marginTop: SIZES.radius }}>
                        <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>
                            Libera tu telefono sin perder su garantia y desde la comodidad de tu casa
                        </Text>
                    </View>
                </View>
            ...
            <View style={{ flex: 1.5 }}>
                ...
                <View style={{ marginTop: SIZES.padding, paddingHorizontal: SIZES.padding }}>
                    <Text style={{ ...FONTS.h2 }}>INFORMACION</Text>
                    <Text style={{ marginTop: SIZES.radius, color: COLORS.gray, ...FONTS.body3 }}>
                        Para aquirir este servicio necesitas tener a la mano el imei de tu equipo y lo obtienes marcando *#06# es un numero conformado por 16 numeros posterir mente recibiras indicaciones.
                    </Text>
                </View>
            </View>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        >
                            ...
                            >
                                <Text style={{ color: COLORS.white, ...FONTS.h2 }}>Adquirir</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    </View>
                </LinearGradient>
